  ...
  valueFormatter = (v) => {
    ...
    render() {
        return (
         ...
         <Widget title={<h5> Enter your details</h5>} close collapse>
       <br/>
       <Form onSubmit={this.onSubmit}>
         ...
         <FormGroup>
           ...
           <FormGroup>
             ...
             <Input type="instructor" name="instructor" id="instructor" color="default" className="btn btn-outline-secondary px-2 mb-2"
         ...
         <FormGroup>
           ...
           <Input type="file" name="file" id="exampleFile" color="default" className="btn btn-outline-secondary px-2 mb-2"
         ...
         <Button color="default" className="width-100 mb-xs mr-xs">Edit</Button>
       </Form>
       </Widget>
             </Col>
         </Row>
