...
class Question extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      selectDefaultData: [
        { value: '', label: 'Select Type', rating: 'safe' },
        { value: 'dropdown', label: 'Dropdown', rating: 'good' },
        { value: 'checkbox', label: 'Check box', rating: 'wild' },
        { value: 'radio', label: 'Radio Button', rating: 'wild' },
        { value: 'text_area', label: 'Text Area ', rating: 'wild' },
        { value: 'text_box', label: 'Text Box', rating: 'wild' },
      ],
      selectService: [
        { value: '', label: 'Select Type', rating: 'safe' },
        { value: '1hour-tatoo', label: '1hour tatoo', rating: 'good' },
        { value: 'Hair-cut', label: 'Hair cut', rating: 'wild' },
        { value: 'Hair-color', label: 'Hair color', rating: 'wild' },
        { value: '2hour-tatoo', label: '2hour tatoo ', rating: 'wild' },
        { value: 'Makeu', label: 'Makeup', rating: 'wild' },
      ],
  ...
  render() {
    ...
    return (
      <div className={s.root}>
        <h1 className="page-title">Question-<span className="fw-semi-bold">Form</span>
        </h1>
        ...
        <Row>
          <Col md="12">
            <Widget
              title={<h6>  <strong>Enter your Question here</strong></h6>} settingsInverse refresh
              close
            >
                  ...
                  <FormGroup row>
                  <Label md="2" for="default-select"></Label>
                  <Col md="6" className={s.select2}>
                    <Select 
                      classNamePrefix="react-select"
                      className="selectCustomization"
                      options={this.state.selectService}
                      defaultValue={this.state.selectService[0]}
                    />
                  </Col>
                  ...
                  <Col md={6}>
                    <Input rows="4" className="input-transparent" type="textarea" name="text" id="default-textarea" placeholder="Add Question" />
                  </Col>
                </FormGroup>
                ...
                <FormGroup row>
                  ...
                  <Col md="6" className={s.select2}>
                    <Select 
                      ...
                      className="selectCustomization"
                      options={this.state.selectDefaultData}
                      defaultValue={this.state.selectDefaultData[0]}
                    />
                  </Col>
                  <div className="text-md-right mt-xs">
                ...
                <FormGroup row>
                 ...
                 <FormGroup row>
                  ...
                  <Col md={8}>
                    ...
                    <div className="text-md-right mt-xs">
                      <Button color="danger" className="mr-xs">Send</Button>
